...
# Список для подсчета количества вызовов нашего бота.
...
# Если выбрана кнопка завтра, скрипт автоматически переводит его в функцую ниже, и выводит кнопки знаков.
...
# Если выбрана кнопка сегодня, скрипт автоматически переводит его в функцую ниже, и выводит кнопки знаков.
...
# Делим данные из базы на 2 части, одна часть отвечает за сегоднящний день, другая часть отвечает за заввтрашний день.
hor_of_data = []
